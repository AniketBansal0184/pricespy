...
// import { generateCategoryProducts } from "@/data/products";
...
//   useEffect(() => {
//     if (categoryId) {
//       const categoryProducts = generateCategoryProducts(categoryId, 15);
...
//           {/* <section className="py-6 bg-indigo-50 text-center my-6 rounded-lg">
//             <p className="text-base sm:text-lg font-medium">
//               📢 Advert Space - Special Promotions!
//             </p>
//           </section> */}
...
export const CategoryPage = () => {
  ...
  // Handle compare toggle (only one product at a time)
          ...
          <div className={`grid gap-4 ${viewMode === "grid" ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" : "grid-cols-1"}`}>
            {filteredProducts.map((product) => (
              <ProductCard
                key={product.id}
                product={product}
                onCompare={handleCompareToggle} // fixed here
                isSelected={isProductSelected(product.id)}
                showCompare={true}
              />
            ))}
